use {
    ...
    std::{process::id, time::SystemTime},
};

// Custom epoch of 2025-10-04T22:34:00Z in milliseconds
pub const EPOCH: u64 = 1_759_606_440_000;
...
impl<'de> Deserialize<'de> for Snowflake {
        ...
        D: Deserializer<'de>,
    {
        ...
        Snowflake::deserialize(deserializer)
            .and_then(|snowflake| match snowflake {
